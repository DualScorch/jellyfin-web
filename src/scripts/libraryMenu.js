...
function refreshLibraryInfoInDrawer(user) {
    ...
    html += '<a is="emby-linkbutton" class="navMenuOption lnkMediaFolder" href="https://mer.jellyfin.nu" target="_blank"><i class="md-icon navMenuOptionIcon"><img style="width: 20.23px; height: 20px;" src="https://github.com/Fallenbagel/jellyseerr/blob/main/public/favicon-32x32.png?raw=true"></i><span class="navMenuOptionText">' + globalize.translate('Requests') + '</span></a>';
